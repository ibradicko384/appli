      ...
      <div class="offcanvas-lg offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto ">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex active align-items-center gap-2 " href="../catego/liste.php">
                <svg class="bi"><use xlink:href="#file-earmark"/></svg>
                Eleves
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 text-dark" href="../parent/parent.php">
                <svg class="bi"><use xlink:href="#cart"/></svg>
                Parent
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 text-dark" href="../buletin/bulletin.php">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 text-dark" href=".php">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Ajouter un parent</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <form action="ajouterel.php" method="POST">
